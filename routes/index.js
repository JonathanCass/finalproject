...
router.post('/users', function(req, res){
  ...
  var sql = 'INSERT INTO users (id, fname, lname, email, avatar, bio, privacy, activities_info, hobbies, interests, age, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'

  conn.query(sql, [req.body.id, req.body.fname, req.body.lname, req.body.email, req.body.avatar, req.body.bio, req.body.privacy, req.body.activities_info, req.body.hobbies, req.body.interests,req.body.age,req.body.gender], function(err, results){
    if(err){
      res.json({
...
router.post('/event', function(req, res){
  var sql = 'INSERT INTO event (id, user_id1, user_id2, activity_id, park_id, time_start, time_stop) VALUES (?, ?, ?, ?, ?, ?)'

  conn.query(sql, [req.body.id, req.body.user_id1, req.body.user_id2, req.body.activity_id, req.body.park_id, req.body.time_start], function(err, results){
    if(err){
      res.json({
...
router.post('/availability', function(req, res){
  var sql = 'INSERT INTO availability (id, user_id, quadrant, day_of_week, from_num, from_suffix, to_num, to_suffix) VALUES (?, ?, ?, ?, ?, ?, ?, ?)'

  conn.query(sql, [req.body.id, req.body.user_id, req.body.quadrant, req.body.day_of_week, req.body.from_num, req.body.from_suffix, req.body.to_num, req.body.to_suffix], function(err, results){
    if(err){
      res.json({
